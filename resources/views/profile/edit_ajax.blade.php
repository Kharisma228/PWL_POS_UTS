...
@else
    ...
    <script>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status) {
                                ...
                                // Perbarui data profil di tampilan
                                updateProfileView(response.data);
                                profile.ajax.reload(); // Reload data tabel jika ada
                            } else {
        ...
        function updateProfileView(data) {
            // Misalnya, perbarui elemen yang menunjukkan username dan nama
            $('#username-display').text(data.username); // Ganti dengan ID yang sesuai
            $('#name-display').text(data.name); // Ganti dengan ID yang sesuai
            // Perbarui elemen lain sesuai kebutuhan
        }
    </script>
@endempty
